...
export const profileConfig: ProfileConfig = {
	avatar: "images/avatar_ghibli.webp", // Relative to the /src directory. Relative to the /public directory if it starts with '/' 原assets/images/demo-avatar.png,可选https://q2.qlogo.cn/headimg_dl?dst_uin=189563385&spec=0
	name: "Sean Patterson",
