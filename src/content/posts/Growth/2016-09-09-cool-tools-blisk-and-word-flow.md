...
image: images/posts/2016-09-blisk_screenshot.png
imageAlt: blisk_screenshot
category: Growth
tags: [apps, bliss, geekery, iphone, mobile, tools, web-development, word-flow]
---

I'm always on the lookout for some cool tools that help me work that much smarter or sometimes are just fun. There are two that I've been warming up to more and more lately: [Blisk](https://blisk.io) (Windows, Mac) and [Word Flow](https://itunes.apple.com/us/app/word-flow-keyboard-custom/id1077864246?mt=8) (iOS)

<!--more-->

## [Blisk - Develop and test websites that look great and work fine on any device](https://blisk.io)

Nowadays, nearly every web site or app I work on is designed to be responsive. Mobile is taking over at a blistering pace and have a responsive site seems like a no brainer, especially with frameworks like [Zurb Foundation](http://foundation.zurb.com) to help make thing happen quick and easy. Testing your site on mobile can be a huge pain. Yes, you can simply drag your browser window to make it skinny to simulate mobile, and the developer tools provide settings, but it can be a bit of a hassle and all of the mobile platforms have their own sizing idosyncracies.
...
## [Microsoft Word Flow Keyboard](https://itunes.apple.com/us/app/word-flow-keyboard-custom/id1077864246?mt=8)
