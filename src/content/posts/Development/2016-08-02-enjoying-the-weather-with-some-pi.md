...
So what do I get with all of this? For starters, I can track the weather at my house now wherever I may be through a web page provided by WU.![](@assets/images/posts/2016-08-wu_home.png)

In addition, I can track it through the Android and iPhone apps that WU provides as well.![](@assets/images/posts/2016-08-20160802_133119000_ios.png)![](@assets/images/posts/2016-08-weather_android.png)

I’m quite a data junkie as well, so with WU, I’ll have all of my data online and aggregated, so I can start looking at weather trends over time, track hottest/coldest days, and lots of things that the standard aggregation on the weather station itself won’t retain.![](@assets/images/posts/2016-08-wu_stats.png)
