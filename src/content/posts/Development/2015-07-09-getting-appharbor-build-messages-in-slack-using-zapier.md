...
The first thing to do is to log in to Zapier and start a new Zap. Click the “Make a Zap!” link at the top of the page or the button on the right in your dashboard.![](@assets/images/posts/2015-07-apphb_2_slack_step1.jpg)

### Setup Triggers/Actions for the Zap

AppHarbor has the ability to publish build status messages to wherever you want through the use of “Service Hooks.” These are simple HTTP POST requests that have the information we need. Fortunately, Zapier has the ability to listen to these items through their own “Web Hooks”. In the “Choose a Trigger” dropdown list use the search feature to type in “WebHook” and select the “WebHook by Zapier” option.![](@assets/images/posts/2015-07-apphb_2_slack_step2.jpg)

Once selected, you’ll see a “Choose Trigger…” option. Click that and choose the “Catch Hook” option.![](@assets/images/posts/2015-07-1_apphb_2_slack_step3.jpg)
...
The message is where the real magic occurs. The Zapier webhook will look at a recent action to provide these fields, so we need to push some code to our repository really quick to get that. I simply modified a readme file and pushed it up to my repostitory. Once that is done, you can click on the “Insert Fields” button to get a list of fields available.![](@assets/images/posts/2015-07-apphb_2_slack_step5.jpg)
...
The rest of the fields here are optional. I did track down an AppHarbor icon online and added it just for some added “cool factor” in my slack channel. Here’s what my final settings look like:![](@assets/images/posts/2015-07-1_apphb_2_slack_step6.jpg)

Scroll down to the bottom and click the “Continue” button.

### Test the Workflow

Now we get to click the “Test” button to have some sample data passed through. Go ahead and click on it. If you’re running Slack, you’ll see your message:![](@assets/images/posts/2015-07-apphb_2_slack_step7.jpg)
