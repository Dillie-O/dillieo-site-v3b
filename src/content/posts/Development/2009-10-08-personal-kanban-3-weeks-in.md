...
image: images/posts/2009-10-101_24041.jpg
...
Not being completely discouraged, I decided to ask the almighty gurus at [StackOverflow](http://stackoverflow.com/questions/1407189/can-agile-scrum-be-used-by-1-or-2-developers) about applying SCRUM to 1 or 2 developers. While the general consensus is that SCRUM itself is indeed for larger teams, there is a lot of Agile methodology that can be used in smaller groups to be successful. One recommendation that came to me was to use a [personal kanban](http://personalkanban.com/personal-kanban-101/). Having heard that word dropped here and there, I was intrigued and decided to invesitgate more.

In a nutshell, "kanban" is the japanese word for billboard. A guy working for Toyota originally developed a kanban at his office to provide an easy visual representation of what is department was currently doing, and what it had to do. More importantly, it also helped to make sure not too much work was being done at once, because interestingly enough, if you're workload is at 100%, [you're not efficient at all](http://personalkanban.com/primers/why-limit-work-in-progress/). A personal kanban is this billboard approach to a department, modified down to you and your workload. At the fundamental level (you can see this in my photo above) you divide your board into three sections:
