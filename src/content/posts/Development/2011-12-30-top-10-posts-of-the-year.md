...
## 1. [Soup to Nuts: Creating a Timeout Notifier in ASP.Net using AJAX Toolkit or jQuery](/soup-to-nuts-creating-a-timeout-notifier-in-asp-net-using-ajax-toolkit-or-jquery)

I've been doing some [How To](/soup-to-nuts-creating-a-timeout-notifier-in-asp-net-using-ajax-toolkit-or-jquery) type articles based on solutions I've found and I'm glad this one made it to the top. A lot of times you get bits and pieces of how to do things, but this was a "soup to nuts" type thing where you could take the entire solution and run with it. They took a bit more work than most of my posts (including doing a VS2008 and VS2010 solution) but I think the effort has been worth it.

## 2. [Soup to Nuts: Extending the User Module in PyroCMS](/soup-to-nuts-extending-the-user-module-in-pyrocms)
...
## 3. [Setting up Roksbox with iTunes and OSX](/setting-up-roksbox-with-itunes-and-osx)

We LOVE out [Roku Box](http://www.roku.com/), and I was looking for a way to stream my iTunes music off my Mac to it. There's a channel called RoksBox that allows you to stream, but you need to do a little work to make it happen. Here's how to set it up.

## 4. [Qakbot: Diagnosis and Removal](/qakbot-diagnosis-and-removal)
...
## 5. [Sorting Latitude/Longitude Positions by Distance in SQL](/sorting-latitudelongitude-positions-by-distance-in-sql)
...
## 6. [Diary of a Qakbot Infection Day 3: War](/diary-of-a-qakbot-infection-day-3-wa)

One of the "dramatic storytelling" entries from the Qakbot infection. This is when we started making progress.

## 7. [Quick Tip: Centering a Login control on a webpage in ASP.Net](/quick-tip-centering-a-login-control-on-a-webpage-in-asp-net)
...
## 8. [Default Category Images for WordPress](/default-category-images-for-wordpress)
...
## 9. [Diary of a Qakbot Infection Day 2: Speechless](/diary-of-a-qakbot-infection-day-2-speechless)
...
## 10. [Integrating the Nivo Slider into a CodeIgniter Site](/ntegrating-the-nivo-slider-into-a-codeigniter-site)
