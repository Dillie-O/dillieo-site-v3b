...
image: images/posts/review_the_book_of_ruby.webp
...
_The Book of Ruby_ is an easy to read book that is perfect for programming beginners or seasoned programmers looking to learn a new language. It covers all the fundamentals of the language, as well as gives a great start into the Rails framework and dynamic programming. The code samples provided make it easy to see the concepts fleshed out in code, and you can easily get your own Ruby environment up and running to learn as you code.
