...
image: images/posts/quick_tip_preserve_svg_text_size_after_scale_transform.webp
imageAlt: Quick Tip
category: Default
tags: [coding, d3, height, javascript, preserve, quick-tip, scale, svg, text, transform]
---

![Quick Tip](../img_post/2013-01-09-quick-tip-preserve-svg-text-size-after-scale-transform/2011-12-quicktip.jpg) I've been battling this one for a little while now. SVG is great for fast graphics rendering and scaling to any dimension, but what do you do when you need to keep your text size the same, regardless of the size of your scaling?
...
![Map Start](../img_post/2013-01-09-quick-tip-preserve-svg-text-size-after-scale-transform/2013-01-mapstart.png)
...
![Map Scale Arizona](../img_post/2013-01-09-quick-tip-preserve-svg-text-size-after-scale-transform/2013-01-mapscalearizona.png)

Now this doesn't look too bad, but some states are smaller than others, which makes the transform REALLY big.

![Map Scale Connecticuit](../img_post/2013-01-09-quick-tip-preserve-svg-text-size-after-scale-transform/2013-01-mapscaleconnecticuit.png)
...
![Map Fixed Arizona](../img_post/2013-01-09-quick-tip-preserve-svg-text-size-after-scale-transform/2013-01-mapfixedarizona.png)

Our super zoom states don't look that bad either...

![Map Fixed Connecticuit](../img_post/2013-01-09-quick-tip-preserve-svg-text-size-after-scale-transform/2013-01-mapfixedconnecticuit.png)
