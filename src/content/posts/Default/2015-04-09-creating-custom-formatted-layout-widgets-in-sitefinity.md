...
image: images/posts/creating_custom_formatted_layout_widgets_in_sitefinity.webp
...
Once you’ve registered the custom layout with your SiteFinity instance (directions found [here](http://docs.sitefinity.com/layout-widgets-create-custom-layout-widgets)), you can create a new page, and then click on the “Layouts” button near the top right of the editor. Your layout should show up in the list: ![](../img_post/2015-04-09-creating-custom-formatted-layout-widgets-in-sitefinity/2015-04-layoutwidgetpanel.png) Drag this layout into your main content area (or elsewhere) and you’ll see the placeholders generated for it: ![](../img_post/2015-04-09-creating-custom-formatted-layout-widgets-in-sitefinity/2015-04-layoutwidgetdrag.png) Finally, go back to the Content view and you can drag/drop content blocks into the necessary areas: ![](../img_post/2015-04-09-creating-custom-formatted-layout-widgets-in-sitefinity/2015-04-layoutwidgetcontent.png) You can see how the styling is applied. Publish your page and view the final results. The nice thing is that the layout widget is independent of anything else in the area in which you place it. You can add more content above and below it as needed: ![](../img_post/2015-04-09-creating-custom-formatted-layout-widgets-in-sitefinity/2015-04-layoutwidgetfinal1.png) There you have it! By working with the special sf_colsOut an sf_colsIn classes, you can go beyond basic layout controls to apply special formatting and create reusable “formatted layout widgets” to use within your SiteFinity pages.
