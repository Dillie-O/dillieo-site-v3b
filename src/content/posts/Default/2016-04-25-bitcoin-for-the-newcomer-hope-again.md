...
I also ran across a nice comprehensive site named [BitMakler](https://bitmakler.net). It has a funky name, but it does have a comprehensive overview of the cryptocurrencies, exchanges, mining pools, and other resources out there. They have even developed a method of testing out the various cloud services with their own test accounts and logging payouts, issues, complications, and the like. Extra data is quite convenient.
