...
image: images/posts/a_new_devtool_on_the_block.webp
imageAlt: A New Devtool On The Block
category: Default
tags: [coding, developer, fde, firefox, tools]
---

A few months back the Mozilla Foundation released a new version of their browser called [Firefox Developer Edition](https://www.mozilla.org/en-US/firefox/developer/) (FDE). While I’m typically a Chrome/Safari kind of guy, I decided to give the new tool a whirl and you know what? I’m rather impressed with it. I haven’t dug into all of its features, but I’m using it more and more and here’s why.
...
There are still a few drawbacks to FDE (anonymous functions do not seem to be debuggable currently) but overall I’ve been one happy _\[insert clever and popular nomenclature for coder here]_ since using it and I’ll probably be sticking with it for a while.

Grab your copy [here](https://www.mozilla.org/en-US/firefox/developer/) and let me know if you stumble across any other cool tricks with FDE.