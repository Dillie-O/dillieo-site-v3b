...
image: images/posts/2015_blogging_in_review.webp
...
While I always seem to have something brewing in my head, taking the time and energy to sit down and "just write" ([as John Saddington has encouraged](http://john.do/today/)) can often be the most daunting. But when you take away distractions, take away worry about what I’m going to say, or how I’m going to say it, the writing comes and it’s quite freeing. If you’ve never started a blog, I’d encourage you to do so. It’s not about fame or fortune. For me, it’s about [sharing the love, and doing some introspection](/why-i-blog). Maybe it’s something different for you, but the writing process is a good one. I highly encourage it.
...
1 - [Fixing Video Display Issues with VMWare Fusion and Windows 10](/fixing-video-display-issues-with-vmware-fusion-and-windows-10)
...
2 - [Laravel 5 Configurations in AWS Elastic Beanstalk](/laravel-5-configurations-in-aws-elastic-beanstalk)
...
3 - [How to Add Foundation Icons to Zurb Foundation for Applications](/how-to-add-foundation-icons-to-zurb-foundation-for-applications)

Another “dog fooding” for my [Prayer Journal](http://prayerjournal.apphb.com) side project. I really love the AngularJS based [Zurb Foundation for Applications](http://foundation.zurb.com/apps.html) that was released this year and managed to build a scaffold for it. Additionally, I added the Zurb Icon library since the library that was included by default was too limited.

4 - [Unboxing and Initial Review - AcuRite 2032CRM Pro Weather Station](/unboxing-and-initial-review-acurite-2032crm-pro-weather-station)
...
5 - [How to Debug Laravel Apps in PHPStorm](/how-to-debug-laravel-apps-in-phpstorm)
