...
image: images/posts/programming_for_kids.webp
...
This past week my girls (nearly 9 now themselves) dived into their first world of programming. Thanks to a site called [Code Studio](http://studio.code.org).
...
So get your kids programming! You can access [Code Studio](http://studio.code.org) from nearly any brower. My girls are actually accessing the lessons from their Nexus 7 tablets without a problem. If you’re looking for other resources, I’ve heard some great things about [Hopscotch](https://www.gethopscotch.com) (for iPad) and UK folks are lucky enough to be able to try out a [Doctor Who based programming game](http://www.bbc.co.uk/cbbc/games) over on the CBBC site.
